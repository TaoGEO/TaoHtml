...
- `references/project-theme-compiler.md`: post-“确认 VI” hash-bound handoff, deterministic project-theme compilation, boundary/fallback policy, explicit project rendering, and verification.
